...
function gotResult(error, results){
    if(error){
        ...
        document.getElementById("result_signal_name1").innerHTML = results[0].label;
        document.getElementById("result_signal_name2").innerHTML = results[1].label;
        ...
        if(results[0].label == "Hello"){
            document.getElementById("update_hand1").innerHTML = "&#128075";
        }
        ...
        if(results[0].label == "Good"){
            document.getElementById("update_hand1").innerHTML = "&#128077";
        }

        if(results[0].label == "Bad"){
            document.getElementById("update_hand1").innerHTML = "&#128078";
        }
        ...
        if(results[1].label == "Hello"){
            document.getElementById("update_hand2").innerHTML = "&#128075";
        }
